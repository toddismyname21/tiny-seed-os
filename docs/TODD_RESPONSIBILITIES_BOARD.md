...
- [x] ~~**AIG R1 reimbursement #002 — Tilmor, $17,497.56**~~ — **SENT 2026-09-24** to michroth@pa.gov.
      Seven orders, itemized invoice + proof of payment for every one. Two form versions enclosed so Roth
      can pick: $17,497.56 with the dibbler, $16,621.56 without. Expect ~$11,665 at the 2/3 rate.
      ⚠️ A first email at 15:06 carried forms with a column error (mine); a correction went at 15:40.
      The 15:40 versions are verified correct. ➡️ WATCH for Roth's reply on the dibbler ruling, and for
      the remittance from RA-OBE-REMITTANCE@pa.gov (001 took ~8 weeks door to door).
