...
3. Use the Read tool to read your instructions: `/Users/samanthapollack/Documents/TIny_Seed_OS/claude_sessions/mobile_employee/INSTRUCTIONS.md`
...
#### Step 3: Verify Work Order UI Works
The new Smart Labor Intelligence was just added to employee.html:
- Check if work orders load via `getMyWorkOrder` endpoint
...
Create: `claude_sessions/mobile_employee/AUDIT_REPORT_2026-01-22.md`
Include:
- Each file checked
