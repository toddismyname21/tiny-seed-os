    ...
    <div style="border: 2px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
      <div style="padding: 20px; border-bottom: 1px solid #e5e7eb;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
          ...
          <span style="background: #dcfce7; color: #166534; padding: 4px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">$15/week</span>
        </div>
      ...
      <div style="padding: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
          ...
          <span style="background: #dcfce7; color: #166534; padding: 4px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">$15/delivery</span>
        </div>
...
async function main() {
  console.log('Fixing delivery price to $15/week...');
  await shopifyRequest('PUT', `pages/${PAGE_ID}.json`, { page: { id: PAGE_ID, body_html: PAGE_HTML } });
  console.log('✓ Done! Price updated to $15/week');
}
