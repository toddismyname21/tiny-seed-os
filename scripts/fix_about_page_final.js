...
<div style="max-width: 720px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #1a1a1a; line-height: 1.7;">
  ...
  <p style="font-size: 17px; margin-bottom: 20px;">
    I believe everyone deserves access to fresh, locally-grown food. I spent a decade learning from local farmers, got my degree in business, and put everything I had into making this work.
  </p>
...
async function main() {
  console.log('Updating About page (removed personal trauma detail)...');
  ...
  if (result.success) {
    console.log('✓ Done. Removed the tacky personal detail.');
